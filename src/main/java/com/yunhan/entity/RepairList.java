...
public class RepairList {
    ...
    public Integer getRepairlistid() {
        return repairlistid;
    }

    public void setRepairlistid(Integer repairlistid) {
    ...
    public String getFinishren() {
        return finishren;
    }

    public void setFinishren(String finishren) {
        this.finishren = finishren;
    }
