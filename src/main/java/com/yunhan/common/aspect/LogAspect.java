package com.yunhan.common.aspect;

import com.alibaba.fastjson.JSONObject;
import com.yunhan.common.annotation.SysLog;
import com.yunhan.common.config.MySysUser;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.yunhan.common.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        SysLog mylog = method.getAnnotation(com.yunhan.common.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
